...
public class BezierCurve extends View {
    ...
    private void init() {
        ...
        int w = getResources().getDisplayMetrics().widthPixels;//屏幕宽度：720
        int h = getResources().getDisplayMetrics().heightPixels;//屏幕高度：1344
        mControlPoints.add(new PointF(100, 100));//
        mControlPoints.add(new PointF(600, 300));//
        mControlPoints.add(new PointF(200, 500));//
        mControlPoints.add(new PointF(500, 600));//
        mControlPoints.add(new PointF(300, 800));//
        mControlPoints.add(new PointF(400, 900));//
